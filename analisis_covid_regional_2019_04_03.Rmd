---
title: "Análisis evolución Covid-19 para regiones de Chile (03/04/2020)"
...
Hoy día es un día relevante, porque ya comenzó la saturación de camas críticas en [Araucanía](https://digital.lasegunda.com/2020/04/03/A/BM3PK838#zoom=page-width),  con 432 casos al día de hoy. Preocupa la situación de Ñuble y Araucanía, donde no se observa desaceleración en los últimos dias.
...
Si observamos la proporción de casos nuevos por día, podemos ver que disminuye en varias regiones de forma relativamente estable (Valparaíso, Metropolitana, Biobío, Araucanía, Los Ríos), en cambio en otras hay fuertes incrementos (Maule y Magallanes) o una tasa estable (Los Lagos).
...
Hemos modificado el algoritmo para iniciar desde 5 casos. Esto permite hacer que las predicciones se acerquen entre sí, siendo optimistas en T+AR(1), siendo bastante pesimistas para Magallanes.
...
Al igual que lo que vimos en días anteriores,con el tiempo, el modelo T+AR(1) tiende a ser más optimista que los modelos basados en la exponencial pura o el ARIMA(1,1,0). Se repite la predicción de ayer, de 7600 para siete días más, lo que contrasta con el modelo más optimista del modelo país total, de 5814. Nuevamente, esto implica que mirar los procesos regionales da un resultado distinto que medir a todo el país, considerando la aparición de focos en regiones de alta importancia.
