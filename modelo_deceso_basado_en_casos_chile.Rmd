...
ols.2<-ols(decesos~casos.0+casos.1+casos.6+casos.7+casos.8+casos.12,chile,x=T,y=T)
validate(ols.2)
```
...
pois.1<-glm(decesos~casos.0+casos.1+casos.6+casos.7+casos.8+casos.12,chile,x=T,y=T,family="poisson")
summary(pois.1)
```
```{r}
