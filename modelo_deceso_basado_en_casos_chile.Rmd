...
La serie de Chile tiene datos para  `r n` días. Si calculamos las correlaciones entre el número de casos y decesos por día, podemos ver que la máxima correlación se observa con un retraso de 6-8 días, descendiendo desde ese unto,
```{r}
c1<-cor(chile)[1,-1]
plot(0:22,c1 )
```
