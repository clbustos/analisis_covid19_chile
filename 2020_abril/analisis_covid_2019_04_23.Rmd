---
title: "Análisis evolución Covid-19 Chile casos y decesos (23/04/2020)"
...
Se puede observar en la serie total que en la última semana prácticamente se ha mantenido estable. Desde hace 2 semanas se observa una leve aceleración en la Metropolitana que parece estar disminuyendo en los últimos dos o tres días. Maule parece haber detenido la aceleración observada desde hace una semana.  Regiones como Antofagasta, Tarapacá y Maule muestran tasas de contagio relativamente constantes a lo largo del periodo.
...
Con respecto a la serie de casos totales de  día vs el anterior, se mantiene constante desde hace días  una tasa de incremento diario de 10% para casi todo el Norte Grande: Arica y Parinacota, Tarapacá y Antofagasta.
...
En la serie de casos nuevos diarios vs los del día anterior, con ventana de 7 días, se puede apreciar un decremento en Valparaíso, Metropolitana, Ñuble y Araucanía. Biobío está estabilizado en 1, al igual que los Ríos y Los Lagos. La serie total desde aproximadamente una semana muestra una tedencia a la estabilización.
...
En el caso del Maule, se puede observar un nuevo aumento en el número de casos.
...
Como ha sido la tónica durante la semana,  el modelo cuadrático es el más  pesimista, pero los modelos T+AR(1) y T+AR(4) tienden a converger. En una semana deberíamos tener entre 13500 y 15810 casos.
...
Durante la semana se ha visto que la predicción del método cuadrático y el de tendencia de casos nuevos comienza a converger, lo cual suele ocurrir cuando las tasas locales dejan de tener variaciones bruscas. Este modelo predice entre 14700 y 15500 casos en una semana.
...
Se debe observar el intervalo de confianza superior elevado en Arica y Parinacota, así como el de Antofagasta y O'Higgins, debido a los cambios recientes en tasas.
...
Una primera serie es la de ventiladores disponibles. Se aprecia un aumento de 24 ventiladores entre ayer y hoy, debido principalmente a que se han dejado de ocupar.
...
Si analizamos la serie total de pacientes en UCI para Covid-19, podemos ver un nuevo máximo en la serie con 399 casos
...
Al analizar la serie por regiones, podemos ver que en su mayoría los casos UCI se encuentran en la Región Metropolitana, que ha aumentado de forma muy fuerte su ocupación desde hace 5 días. En el resto de las regiones, permanece relativamente estable la ocupación de todas las regiones en los últimos días, aunque preocupa el ascenso lento, pero sostenido en la región de Magallanes.
...
Si observamos la serie total de decesos, observamos una tasa relativamente constante en los últimos 9 días, atribuible a la región Metropolitana, ya que el resto de las series muestra menor cantidad de casos.
