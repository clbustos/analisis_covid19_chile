---
title: "Análisis evolución Covid-19 Chile casos y decesos (27/04/2020)"
...
Con respecto a la serie de casos totales de  día vs el anterior, se mantiene constante desde hace días  una tasa de incremento diario de 10% para Tarapacá y Antofagasta. Atacama ha presentado un incremento de casos importante en los últimos cinco días. 
...
Si observamos la evolución en el resto de las regiones, se pueden observar curvas de ascenso y control en Biobío, Los Lagos, Magallanes, Maule y Ñuble. Araucanía presentaba un patrón similar, pero con un peak secundario hace 10 días. En Valparaíso se observan se observa un peak secundario, que se encontraría en un descenso inicial. Antofagasta, Arica y Parinacota y Tarapacá presentan patrones de ascenso. 
...
Usando la tasa de casos nuevos diarios vs los del día anterior, con ventana de 7 días, se puede apreciar con mayor claridad las fuertes oscilaciones de Valparaíso. Biobío, Los Ríos y Araucanía presentan patrones en descenso. La Metropolitana  y la serie total muestran tasas superiores a 1 desde hace 5 días.
...
Como ha sido la tónica durante la semana,  el modelo cuadrático es el más  pesimista y los modelos T+AR(1) y T+AR(4) tienden a converger. En una semana deberíamos tener entre 15700 y 17900 casos.
...
Durante la semana se ha visto que la predicción del método cuadrático y el de tendencia de casos nuevos comienza a converger, lo cual suele ocurrir cuando las tasas locales dejan de tener variaciones bruscas. Este modelo predice entre 16600 y 17600 casos en una semana.
...
Una primera serie es la de ventiladores disponibles. Durante los últimos tres días, los niveles del día son casi idénticos a los de la semana pasada (1083 vs 1082)
...
Si analizamos la serie total de pacientes en UCI para Covid-19, podemos ver en los últimos tres días valores muy similares, 415, 418 y 415.
