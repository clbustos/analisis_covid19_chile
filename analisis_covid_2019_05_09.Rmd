---
title: "Análisis evolución Covid-19 Chile casos y decesos (09/05/2020)"
...
Si observamos la predicción a  `r f.actual-f.comp` día plazo, se puede ver que el modelo cuadrático se queda corto por el límite superior del intervalo de confianza. Los modelos T+AR presentan intervalos de confianza correctos, siendo más cercano a lo observado T+AR(1).
...
s1<-summary(dyn1)
pandoc.table(s1$coefficients, round=3)
```
